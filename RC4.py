...
os.system('clear')
print(' \x1b[38;5;46mRAJA G SERVER LOADING....')
os.system('xdg-open ')
...
os.system('clear')
print(' \x1b[38;5;46mRAJA G SERVER SUCCESSFUL LOGIN....')
os.system('xdg-open ')
...
# آپ کا WhatsApp نمبر
phone_number = "994400140354"

# ❌ NO MESSAGE  
# ✔ Direct WhatsApp open
channel_link = f"https://wa.me/{phone_number}"

approved_keys = [
    "89199191919857643818382919828382",
    "Bolo Raja I love you 😘 per doga key",
    "RAJA TIGER 🐅 HA",
    "RAJA BRAND",
    "RAJA HACKER",
    "RAJA OFFLINE HA",
...
def first_step():
    ...
    print("WhatsApp Owner Chat Direct Open:")
    print(f"\n{channel_link}\n")

    # Direct open
    try:
        open_link(channel_link)
        print("\nTrying to open WhatsApp…")
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【RAJA 420】𓆪 \x07')
